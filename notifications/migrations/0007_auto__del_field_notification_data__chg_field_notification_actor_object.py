...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.actor_object_id'
        db.alter_column('notifications_notification', 'actor_object_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Notification.actor_content_type'
        db.alter_column('notifications_notification', 'actor_content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contenttypes.ContentType']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Notification.actor_object_id'
        db.alter_column('notifications_notification', 'actor_object_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))

        # Changing field 'Notification.actor_content_type'
        db.alter_column('notifications_notification', 'actor_content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        'notifications.notification': {
            ...
            'actor_content_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'notify_actor'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
